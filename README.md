...
### tasks left
- [ ] phase 4: training utilities (cross-entropy, gradient clipping, cosine lr schedule, custom adamw optimizer)
- [ ] phase 5: data loading & checkpointing (batching, save/load checkpoints)
- [ ] phase 6: text generation (sampling & temperature)
- [ ] phase 7: training loop & scaling law experiments
